...
INSERT INTO PHIEUDK VALUES ('000112069','2038', '12022', '27-5-2022');
...
CREATE TABLE TAIKHOAN (
    TenDangNhap VARCHAR (8) NOT NULL PRIMARY KEY,
    MatKhau     VARCHAR (8) NULL,
    Quyen       VARCHAR (5) NULL,
    
)
INSERT INTO TAIKHOAN VALUES (20520724, '123', 'user');
